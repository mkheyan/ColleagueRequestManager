...
{
    public partial class InitialDbCreationV1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NecessaryCompletionDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToDoItems_AspNetUsers_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToDoHistory_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToDoResponses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ToDoResponses_AspNetUsers_ResponderId",
                        column: x => x.ResponderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ToDoResponses_ToDoItems_ToDoItemId",
                        column: x => x.ToDoItemId,
                        principalTable: "ToDoItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ToDoAttachments_AspNetUsers_UploaderId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ToDoAttachments_ToDoResponses_ResponseId",
                        column: x => x.ResponseId,
                        principalTable: "ToDoResponses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToDoAttachments_ResponseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToDoAttachments_UploaderId",
                table: "ToDoAttachments",
                column: "UploaderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToDoResponses_ResponderId",
                table: "ToDoResponses",
                column: "ResponderId");

            migrationBuilder.CreateIndex(
                name: "IX_ToDoResponses_ToDoItemId",
                table: "ToDoResponses",
                column: "ToDoItemId");
        }
